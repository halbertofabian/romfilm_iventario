<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?= HTTP_HOST . 'app/' ?>assets/img/romfilm/logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?= HTTP_HOST . 'app/' ?>assets/img/romfilm/logo.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?= HTTP_HOST . 'app/' ?>assets/img/romfilm/logo.png">
