...
<body>
  ...
  <?php if (isset($_SESSION['session_start']) && $_SESSION['session_start']) : ?>
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <?php $app->loadComponent('vertical-navbar'); ?>
        ...
        <div class="btn-group d-block w-100 btn-group-navbar-style">
          <div class="row gx-2">
            ...
            <div class="col-6">
              ...
              <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark"> <span class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0" src="../../assets/img/generic/falcon-mode-dark.jpg" alt="" /></span><span class="label-text">
                  Dark</span></label>
            </div>
          </div>
        </div>
  ...
  <?php $app->loadComponent('scripts-app'); ?>
